...
function getRecipesFromStorage() {
  ...
  if (JSON.parse(window.localStorage.getItem("recipes")) == null) {
    return [];
  }
...
function addRecipesToDocument(recipes) {
  ...
  recipes.forEach((recipe) => {
    ...
    main_element.appendChild(newRecipe);
  });
}
...
function initFormHandler() {
  ...
  let clearLocalStorage_button = document.getElementsByClassName("danger")[0];
  // B11. TODO - Add a click event listener to clear local storage button
  clearLocalStorage_button.addEventListener("click", () => {
